...
import com.khudyakovvladimir.vhfileexplorer.widgets.ExplorerRecyclerViewAdapter
...
class FileListFragment: Fragment() {
    ...
    private lateinit var explorerRecyclerViewAdapter: ExplorerRecyclerViewAdapter
    ...
    override fun onAttach(context: Context) {
        context.appComponent.injectFileListFragment(this)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        explorerRecyclerViewAdapter = ExplorerRecyclerViewAdapter(
        ...
        val callback: OnBackPressedCallback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if(Model.stack.size > 1) {
                    ...
                    fileExplorerViewModel.createDisposable(adapterPosition) {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        when(codeForMenu) {
            0 -> { inflater.inflate(R.menu.action_bar_menu, menu) }
